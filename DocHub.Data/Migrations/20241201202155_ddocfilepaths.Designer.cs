...
namespace DocHub.Data.Migrations
{
    ...
    [Migration("20241201202155_ddocfilepaths")]
    partial class ddocfilepaths
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocHub.Core.Entities.DDocFilePath", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocHub.Core.Entities.DDocFilePath", b =>
                {
                    b.HasOne("DocHub.Core.Entities.DDocument", "Doc")
                        .WithMany("FilePaths")
                        .HasForeignKey("DocId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
